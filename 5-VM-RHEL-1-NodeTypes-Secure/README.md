...
This template allows you to deploy a secure 5 node, Single Node Type Service Fabric Cluster running RHEL on a Standard_D2_v2 Size Virtual Machine Scale set with Azure Diagnostics turned on. 
