...
This template allows you to deploy a Service Fabric managed cluster using the *Basic* SKU. This cluster contains a single node type running *Windows Server 2019 Datacenter* on a *Standard_D2_v3* size virtual machine scale set.
